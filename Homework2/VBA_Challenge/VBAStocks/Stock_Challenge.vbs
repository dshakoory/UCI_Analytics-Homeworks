...
'All variables defined as String'
 ...
 ws.Range("L1").Value = "Annual Change"
...
'Adding the data into the cells'
    ...
    'Changing the format of the data to percentage'
         ...
         If ws.Range("J" & y).Value > 0 Then
            ...
            ws.Range("J" & y).Interior.ColorIndex = 4 'green'
         Else
 ...
 'Looping through the tickers,total value of stocks and the percentage changes find the largest'
 For z = 2 To lrd:
 ...
 'Adding data to the related cells and changing the format of the values in Data column to percent'
 ws.Range("O2") = tck_gtv
 ws.Range("O3") = tck_gi
 ws.Range("O4") = tck_gd
 ws.Range("P2") = gtv
